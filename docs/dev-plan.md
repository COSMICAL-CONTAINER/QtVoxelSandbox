...
**t1025 动物繁殖**：手持对应食物（牛/羊=小麦、猪=胡萝卜、鸡=种子）右键动物→进**恋爱模式**（爱心粒子，30s 冷却）；两只同种均恋爱态且相距 ≤3 格→产**幼崽**（0.5× 缩放——复用 t1008 baby halfH 基建；跟随父母；20 min→成体，游戏内天数口径可调短登记）；繁殖后 5 min 冷却。幼崽不可繁殖/血量减半。探针：引诱跟随/喂食恋爱/双满产崽/幼崽缩放字段与成长/冷却门。
