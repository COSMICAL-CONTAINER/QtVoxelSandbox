...
**t979** 猪两修：① 猪死亡掉落**皮革**（错——对照 MC 1.0 掉落表：生猪排；若火焰致死走熟排则核既有火焰链口径）；② 猪在**水位 1/8、1/4**（水格高度的 1/8 与 1/4，脚踝深、身子远未没入）居然会**淹死**——明明一直在努力往上跳还是淹死。溺水判定应按身体淹没程度（水位高度 vs 口鼻/眼部高度一类的单一权威），不能脚位格沾水就窒息计时；浅水 + 跳跃应能脱困。验收：1/8、1/4 水位猪零溺水伤且能跳出；没顶深水溺水链仍有效；掉落表修正。
**t980** 鱿鱼陆地生存：鱿鱼在**陆地上保持行走步态且不掉血不死**。两修：陆上窒息掉血至死（MC 1.0 语义——离水持续受伤）；陆上移动语义不再是行走步态（挣扎/缓动）。验收：陆上面持续掉血可至死亡；水中游动/漂浮行为零回归。
