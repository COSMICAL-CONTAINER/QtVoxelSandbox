...
**t984** 仙人掌旁放铁轨（口径翻案，用户 9-01 原话：「我的口径是能放下来，而不是仙人掌会掉落，你之前一直都做错了」）：铁轨邻接仙人掌应**能放下来**，仙人掌**不掉落**。仙人掌破坏校验只应被**完整实体方块**的水平邻接触发（MC 语义）；铁轨/火把等非完整方块不触发。连带核与 t503（仙人掌 worldgen/挖除链）口径一致。验收：仙人掌四邻放铁轨成功、仙人掌不动；完整方块邻接仍照旧触发破坏掉落。
**t985** 仙人掌底接触阴影：仙人掌放在沙子上**没占满一个平面格子（这是对的）**，但**底部沙子与仙人掌接触的部分整片变成阴影**。修不满格方块对支撑面的 AO/光照——矮窄侧面不该把支撑面顶面压出大片阴影。验收：沙上仙人掌正下方及周围沙面无异常阴影带；其它不满格方块（铁轨/按钮/雪层）支撑面同查同修。
