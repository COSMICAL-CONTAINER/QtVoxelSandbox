...
//   0x20E 羊毛   —— 白色蓬松块 + 卷曲纹（t242；t834/review #7 退役：无掉落/配方来源，仅旧存档物品图标）。
...
Item {
    ...
    Canvas {
        ...
        onPaint: {
            ...
            //   羊毛 0x20E —— 白色蓬松块（圆角 + 浅灰阴影表「绒毛团」；t834/review #7 退役：无掉落来源，仅旧存档）。
            ...
            // 羊毛（0x20E，t242）：t834/review #7 退役（杀/剪白羊改掉 Wool 方块 27，本 id 无掉落源，仅旧存档
            //   物品图标兼容）。MC 风格羊毛 = 白色蓬松块（圆角 + 浅灰阴影表「绒毛团」）。
            ...
            // t447 骨粉（0x232）：骨头合成产物（1 骨头 → 3 骨粉），右键催熟生长类方块（t791：作物每骨粉 +2..3
            //   阶段、3-4 个催熟一株；树苗 45% 概率成树；浆果丛 +1 阶段）。MC 风格骨粉 = 米白
            ...
            case 0x20E: drawWool();         break // t242；t834 退役（仅旧存档图标，杀/剪白羊现掉 Wool 方块 27）
